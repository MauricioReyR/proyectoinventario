<div class="card">
    <div class="card-header p-0">
        <h3 class="card-title">{{ __('CreateTitle', ['name' => __('Contactenos') ]) }}</h3>
        <div class="px-2 mt-4">
            <ul class="breadcrumb mt-3 py-3 px-4 rounded">
                <li class="breadcrumb-item"><a href="@route(getRouteName().'.home')" class="text-decoration-none">{{ __('Dashboard') }}</a></li>
                <li class="breadcrumb-item"><a href="@route(getRouteName().'.contactenos.read')" class="text-decoration-none">{{ __(\Illuminate\Support\Str::plural('Contactenos')) }}</a></li>
    ...
    <form class="form-horizontal" wire:submit.prevent="create" enctype="multipart/form-data">
        ...
        <div class="card-footer">
            ...
            <a href="@route(getRouteName().'.contactenos.read')" class="btn btn-default float-left">{{ __('Cancel') }}</a>
        </div>
    </form>
</div>
