                ...
                <table class="table table-hover table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style='cursor: pointer' wire:click="sort('size')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'size') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'size') fa-sort-amount-up ml-2 @endif'></i> {{ __('Size') }} </th>
                            ...
                            <th scope="col" style='cursor: pointer' wire:click="sort('material')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'material') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'material') fa-sort-amount-up ml-2 @endif'></i> {{ __('Material') }} </th>
                            ...
                            <th scope="col" style='cursor: pointer' wire:click="sort('priceSale')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'priceSale') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'priceSale') fa-sort-amount-up ml-2 @endif'></i> {{ __('PriceSale') }} </th>
